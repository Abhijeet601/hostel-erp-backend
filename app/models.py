...
class HostelApplication(Base):
    ...
    aadhar_card_data: Mapped[str | None] = mapped_column(Text().with_variant(LONGTEXT, "mysql"))
    admission_receipt_data: Mapped[str | None] = mapped_column(Text().with_variant(LONGTEXT, "mysql"))
    income_certificate_data: Mapped[str | None] = mapped_column(Text().with_variant(LONGTEXT, "mysql"))
    caste_certificate_data: Mapped[str | None] = mapped_column(Text().with_variant(LONGTEXT, "mysql"))
    existing_hostel_name: Mapped[str | None] = mapped_column(String(120))
    existing_room_number: Mapped[str | None] = mapped_column(String(40))
    existing_bed_number: Mapped[str | None] = mapped_column(String(40))
    existing_block: Mapped[str | None] = mapped_column(String(40))
    existing_floor: Mapped[str | None] = mapped_column(String(40))
    existing_previous_session: Mapped[str | None] = mapped_column(String(20))
...
class Payment(Base):
    ...
    tracking_id: Mapped[str | None] = mapped_column(String(80), index=True)
    bank_ref_no: Mapped[str | None] = mapped_column(String(80), index=True)
    failure_reason: Mapped[str | None] = mapped_column(String(255))
    sub_account_id: Mapped[str | None] = mapped_column(String(80), index=True)
